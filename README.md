...
## 개발 철학 및 마음가짐
> 항상 이런 생각으로 개발에 임하라.“내 소스를 유지보수하게 될 개발자는 내가 어디 살고 있는지 알고 싶어하는 과격한 사이코패스일 것이다.”  Martin Goldin

좋은 개발자는 다른 사람이 내 코드를 읽었을 때 쉽게 이해할 수 있도록 코드를 짜는 사람이라고 생각합나다.
코드를 작성할 떄 항상 미래의 메인 테너가 누가 될지 생각하고 작성하였습니다. 이 코드가 무엇을 하는 것인지 쉽게 이해할수 있게 작성하였고 리팩톨이 하였습니다.
...
## 4. ERD 
> DB를 설계 하면서 고민했던 주요 상세 내용 확인 → 👉[db설계 고민](https://bwj1207.tistory.com/118) `Ctrl + 마우스 좌클릭`
---
<details>
  <summary> ERD</summary>
</details>
